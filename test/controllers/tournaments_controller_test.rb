...
class TournamentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tournament" do
    assert_difference("Tournament.count") do
      post tournaments_url, params: { tournament: { name: @tournament.name, user_id: @tournament.user_id } }
    end
  ...
  test "should update tournament" do
    patch tournament_url(@tournament), params: { tournament: { name: @tournament.name, user_id: @tournament.user_id } }
